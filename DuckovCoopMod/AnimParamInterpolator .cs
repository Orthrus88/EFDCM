...
namespace DuckovCoopMod
{
    public struct AnimSample
    {
        ...
        public bool attack;        // Compatible with your current Attack(bool)
        public int stateHash;      // Optional: state sync
        public float normTime;     // Optional: normalized time
    }

    public class AnimParamInterpolator : MonoBehaviour
    {
        [Header("Time Window")] // Editor hint
        ...
        [Header("State Transition (Optional)")]
